...
(function (global) {
  ...
  /* ==========================================================================
     ...
     - px  : chart_orion.jpg 안의 예상 픽셀 좌표(좌상단 0,0).
             ...
             교사가 확정한 값을 config.json 으로 배포한다.
     ========================================================================== */
  var STARS = [
    { id: 1,  kor: '시리우스',   trad: '천랑(天狼)',            mag: -1.5, px: { x: 1276, y: 1966 } },
    { id: 2,  kor: '리겔',       trad: '삼수 일곱째 별(參宿七)', mag:  0.1, px: { x: 1634, y:  950 } },
    { id: 3,  kor: '카펠라',     trad: '오거 둘째 별(五車二)',   mag:  0.1, px: { x:  294, y:  480 } },
    { id: 4,  kor: '프로키온',   trad: '남하 셋째 별(南河三)',   mag:  0.4, px: { x:  454, y: 1920 } },
    { id: 5,  kor: '베텔게우스', trad: '삼수 넷째 별(參宿四)',   mag:  0.4, px: { x: 1088, y: 1160 }, note: '변광성' },
    { id: 6,  kor: '알데바란',   trad: '필수 다섯째 별(畢宿五)', mag:  0.9, px: { x: 1108, y:  418 } },
    { id: 7,  kor: '벨라트릭스', trad: '삼수 다섯째 별(參宿五)', mag:  1.6, px: { x: 1238, y:  916 } },
    { id: 8,  kor: '알닐람',     trad: '삼수 둘째 별(參宿二)',   mag:  1.7, px: { x: 1374, y: 1098 } },
    { id: 9,  kor: '알니탁',     trad: '삼수 첫째 별(參宿一)',   mag:  1.7, px: { x: 1372, y: 1148 } },
    { id: 10, kor: '사이프',     trad: '삼수 여섯째 별(參宿六)', mag:  2.1, px: { x: 1516, y: 1310 } },
    { id: 11, kor: '민타카',     trad: '삼수 셋째 별(參宿三)',   mag:  2.2, px: { x: 1372, y: 1048 } },
    { id: 12, kor: '메이사',     trad: '자수 첫째 별(觜宿一)',   mag:  3.4, px: { x: 1114, y:  964 } }
  ];
  ...
  var CONCLUSIONS = [
    '밝은 별일수록 크게 새겨져 있었다.',
    '조선은 숫자 대신 <b>크기</b>로 별의 밝기를 기록한 것이다.',
    '우리가 오늘 잰 값과 현대 천문학의 등급이 비슷하게 맞았다.',
    '망원경도 없던 600년 전에, 우리 조상들은 눈으로 보고 밝기까지 구분해 기록했다.'
  ];
